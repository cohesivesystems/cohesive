...
public static class FreightMaterializationInfrastructure
{
    ...
    public static InfrastructureLocalTopology CreateTopology() => InfrastructureLocal.Define(local => local
        ...
        .Service(resource: PostgresResource, physicalResource: PostgresService, image: "postgres:17.10-alpine3.24", configure: postgres => postgres
            ...
            .Endpoint(id: new("postgres"), scheme: "postgresql", servicePort: 5432, exposure: InfrastructureLocalEndpointExposure.HostLoopback, role: InfrastructureLocalEndpointRole.Data, hostPort: Configuration(Settings.PostgresPort))
        ...
        .Service(resource: CosmosResource, physicalResource: CosmosService, image: "mcr.microsoft.com/cosmosdb/linux/azure-cosmos-emulator:vnext-EN20260810", configure: cosmos => cosmos
            ...
            .Endpoint(id: new("cosmos"), scheme: "https", servicePort: Configuration(Settings.CosmosPort), exposure: InfrastructureLocalEndpointExposure.HostLoopback, role: InfrastructureLocalEndpointRole.Data, hostPort: Configuration(Settings.CosmosPort))
            .Endpoint(id: new("health"), scheme: "http", servicePort: 8080, exposure: InfrastructureLocalEndpointExposure.HostLoopback, role: InfrastructureLocalEndpointRole.Management, hostPort: Configuration(Settings.CosmosHealthPort))
            .Endpoint(id: new("explorer"), scheme: "http", servicePort: 1234, exposure: InfrastructureLocalEndpointExposure.HostLoopback, role: InfrastructureLocalEndpointRole.UserInterface, hostPort: Configuration(Settings.CosmosExplorerPort))
        ...
        .Service(resource: ElasticsearchResource, physicalResource: ElasticsearchService, image: "docker.elastic.co/elasticsearch/elasticsearch:8.19.13", configure: elastic => elastic
            ...
            .Endpoint(id: new("http"), scheme: "http", servicePort: 9200, exposure: InfrastructureLocalEndpointExposure.HostLoopback, role: InfrastructureLocalEndpointRole.Data, hostPort: Configuration(Settings.ElasticsearchPort))
        ...
        .Service(resource: PgAdminResource, physicalResource: PgAdminService, image: "dpage/pgadmin4:9.17", configure: pgadmin => pgadmin
            ...
            .Endpoint(id: new("ui"), scheme: "http", servicePort: 80, exposure: InfrastructureLocalEndpointExposure.HostLoopback, role: InfrastructureLocalEndpointRole.UserInterface, hostPort: Configuration(Settings.PgAdminPort))
        ...
        .Service(resource: KibanaResource, physicalResource: KibanaService, image: "docker.elastic.co/kibana/kibana:8.19.13", configure: kibana => kibana
            ...
            .Endpoint(id: new("ui"), scheme: "http", servicePort: 5601, exposure: InfrastructureLocalEndpointExposure.HostLoopback, role: InfrastructureLocalEndpointRole.UserInterface, hostPort: Configuration(Settings.KibanaPort))
