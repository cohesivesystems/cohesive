...
echo "Cohesive.Simulation packages $version installed and verified scenario traces, external imports, catalogs, core artifacts, and relationship-world artifacts."
