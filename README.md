...
| [`Cohesive.Adapters.Azure.Infra`](src/adapters/Cohesive.Adapters.Azure.Infra/README.md) | Exact Azure evidence admission plus bounded ARM provisioning and platform-health collection; application admission and live qualification remain follow-ups. |
...
| [`Cohesive.Adapters.AspNet.Azure.Infra`](src/adapters/Cohesive.Adapters.AspNet.Azure.Infra/README.md) | Protected, explicitly attributed ASP.NET workload-admission evidence producers. |
