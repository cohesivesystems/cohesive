...
| `RepeatAcrossActivationProcessNode` | Durable recurrence, occurrence bound, progress proof, optional exact next-occurrence state, exhausted and stalled outcomes | Durable reactivation or continue-as-new while retaining canonical recurrence evidence and restoring its typed state before body entry | Composed |
