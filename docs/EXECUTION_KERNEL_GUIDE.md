...
| Delegate-bearing Process nodes and registry-by-name definitions | `ProcessAuthoring` or direct canonical Process IR in `ExecutionDefinitionDocument` | Persisted semantics contain finite inspectable control flow and no retained delegate |
