...
shipped execution authorities. The remaining scenarios retain the classifications recorded below.
...
evidence cannot be rewritten. Terminal continuations still admit late inputs durably for policy and audit; the
