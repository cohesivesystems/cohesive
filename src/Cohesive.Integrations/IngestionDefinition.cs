...
/// <param name="AdvanceLedger">Optional exact Request advancing a separate ledger from confirmed publication evidence before settlement.</param>
/// <param name="Settle">Exact Request settling source work after publication and any separate ledger advancement; its payload receives prior-step evidence.</param>
/// <remarks>
...
/// an application Process that performs them. An optional AdvanceLedger Request selects the separate-ledger profile.
/// Early acknowledgment is unsupported. Request declarations are requirements, not proof that a physical adapter preserves them.
/// </remarks>
public sealed record IngestionDefinition(
    ...
    [property: JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] RequestContractReference? AdvanceLedger = null);
