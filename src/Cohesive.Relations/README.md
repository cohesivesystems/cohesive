...
explicit nested fields, statically keyed object construction, explicit `coalesce` defaults, key-based collection `join` and collection `select` with shape-aware
