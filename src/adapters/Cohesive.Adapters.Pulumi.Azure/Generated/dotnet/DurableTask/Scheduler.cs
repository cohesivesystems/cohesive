...
namespace Pulumi.AzureNative_durabletask_v20251101.DurableTask
{
    ...
    /// </summary>
    [AzureNative_durabletask_v20251101ResourceType("azure-native_durabletask_v20251101:durabletask:Scheduler")]
    public partial class Scheduler : global::Pulumi.CustomResource
    {
        ...
        public Scheduler(string name, SchedulerArgs args, CustomResourceOptions? options = null)
            : base("azure-native_durabletask_v20251101:durabletask:Scheduler", name, args ?? new SchedulerArgs(), MakeResourceOptions(options, ""), Utilities.PackageParameterization())
        {
        }

        private Scheduler(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("azure-native_durabletask_v20251101:durabletask:Scheduler", name, null, MakeResourceOptions(options, id), Utilities.PackageParameterization())
        {
        }
