# Cohesive.Adapters.Elastic internals

This document contains the complete Elasticsearch bindings, compilation, pagination, aggregation, and materialization
contracts behind the [adapter overview](README.md).
...
[Cohesive.Relations static compilation](https://github.com/cohesivesystems/cohesive/blob/main/src/Cohesive.Relations/docs/internals/COMPILATION_AND_REALIZATION.md#demand-driven-static-compilation):
