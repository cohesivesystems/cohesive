# Cohesive.Adapters.Cosmos internals

This document contains the complete Cosmos DB bindings, compilation, acquisition, storage, and runtime contracts
behind the [adapter overview](README.md).
...
- You need Process-invoked entity Transitions with atomic state and replay evidence.
