...
/// <summary>
/// ONNX-backed feature-vector scoring model for MLP-style tabular inference.
/// </summary>
public sealed class OnnxMlpFeatureVectorScoringModel : IFeatureVectorScoringModel, IDisposable
{
    ...
    /// <summary>
    /// Creates an ONNX MLP feature-vector scoring model.
    /// </summary>
    public OnnxMlpFeatureVectorScoringModel(
        string modelName,
        string version,
        string modelPath,
        ...
        )
    {
        ...
        this.outputName = session.ResolveOutputName(outputName, "logit", "prob", "score");
    }

    /// <summary>
    /// Creates a model directly from an export directory.
    /// </summary>
    public static OnnxMlpFeatureVectorScoringModel CreateFromExportDirectory(
        ...
        )
    {
        ...
        var inputShape = new long[] { batchCount, featureCount };
        ...
        IReadOnlyCollection<OrtValue> inputValues = [inputOrtValue];
